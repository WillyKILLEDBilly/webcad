...
@section('css')
	@parent
	<link rel="stylesheet" type="text/css" href="{{asset('public/'.'frontend/css/app/home.css')}}">
@stop
...
@section('header')
	@parent
	<div class="q-header-background" >
		<!--<div class="q-header-info q-shadow-text">
			{{trans('home.header_info')}}
		</div>-->
		<canvas  id="canvas"></canvas>
		<div class="container">
			<div class="q-header-logo">
				<img src="{{URL::asset('public'.'\frontend\img\home\3d-logo.png')}}">
			</div>
			<div class="q-header-info">WEBCAD - це безкоштовний ресурс 3D моделей різноманітних деталей</div>
		</div>
...
@section('content')
	@include('home.info')
	<div id="q-details-table" class="q-details-table-wrapper">
		<div class="q-details-table container">
			@foreach($details->chunk(3) as $chunk)
			    <div class="row">
			    	@foreach($chunk as $detail)
							@component('home.detailPreview',compact('detail'))
							@endcomponent
					@endforeach
				</div>
			@endforeach
...
@section('body_scripts')
	@parent
	<script type="text/javascript" src="{{URL::asset('public/frontend/js/app/home.js')}}"></script>
	<script type="text/javascript">
		(function(){
			var canvasBody = document.getElementById("canvas"),
					...
					h = canvasBody.height = window.innerHeight;//window.innerHeight, 
